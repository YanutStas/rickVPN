module.exports = {
  startMessage: (userName) =>
    `*Привет, ${userName}!* Я rickVPN, и я помогу тебе получить доступ к свободному интернету. Заблокирован Instagram, Facebook или ещё что-то? Забей! Со мной ты забудешь об этих жалких ограничениях. Хватит ждать, подключайся и будь свободен!`,
