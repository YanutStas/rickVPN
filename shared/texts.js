module.exports = {
  ...
  instructionMessage: `
*Инструкция*:\n
1. Прочитай эту инструкцию.\n
2. Выбери тариф.\n
3. Оплати тариф(как это сделать узнаешь после выбора тарифа).\n
4. Пришли чек в этот чат.\n
5. Ожидай ответа от админа.\n
6. После получения ключа следуй инструкции по подключению.
`,
