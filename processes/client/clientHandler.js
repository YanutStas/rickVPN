...
module.exports.init = (bot) => {
  ...
  bot.on("callback_query", (callbackQuery) => {
    ...
    switch (action) {
      ...
      case "tariff_3000_semiannual":
        // Сохраняем информацию о тарифе для пользователя
        userTariffs[chatId] = action;
  ...
  bot.on("message", (msg) => {
    ...
    if (msg.photo || msg.document) {
      ...
      // Передаем тариф для обработки чека
      manageRequests.handle(bot, msg, userTariffs[chatId]);
      logger.info(
